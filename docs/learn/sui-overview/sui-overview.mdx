...
Sui is a [smart contract](../../references/sui-glossary.mdx#smart-contract) platform maintained by a permissionless set of [validators](../../references/sui-glossary.mdx#validator) that play a role similar to validators or miners in other blockchain systems.
...
Sui is backed by a number of state-of-the-art [peer-reviewed works](../../references/research-papers.mdx) and years of open source development.
