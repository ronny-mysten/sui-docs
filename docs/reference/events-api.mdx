...
Sui [Full nodes](../contribute/nodes/full-node.mdx) support publish / subscribe using [JSON-RPC](../reference/json-rpc/read-api.mdx) notifications via the WebSocket
