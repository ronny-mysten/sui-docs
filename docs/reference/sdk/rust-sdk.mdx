...
:::tip
The WebSocket client supports only [subscription](reference/events-api.mdx#subscribe-events); use the HTTP client for other API methods.
:::
...
Use the WebSocket client to [subscribe to events](../events-api.mdx#subscribe-events).
