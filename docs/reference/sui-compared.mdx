...
1.  The validators execute the transaction and sign the results. When the client receives a Byzantine-resistant-majority of the results _finality_ is reached, i.e., assurance the transaction will not be dropped (revoked).
